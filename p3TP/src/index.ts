...
//     try {
//         const response = await fetch('http://localhost:3001/api/estudante', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
//             },
...
//     { nome: "Marcos_da_Silva", idade: 21, email: "marcos.silva@fatec.sp.gov.br", telefone: "12912343567" },
//     { nome: "Ana_Maria_Brega", idade: 25, email: "ana.brega@fatec.sp.gov.br", telefone: "12999979999" },
//     { nome: "Paulo_França", idade: 18, email: "paulo.fraca@fatec.sp.gov.br", telefone: "12999967999" },
...
const buscarEstudantes = async () => {
    try {
        ...
        estudantes.forEach((estudante: any) => {
            const mediaArredondada = estudante.media.toLocaleString('pt-BR', {
            ...
            console.log(`Nome: ${estudante.pessoa}`);  // A pessoa já está sendo retornada como o nome do estudante
            console.log(`Média: ${mediaArredondada}`);
            console.log("--------------");
        });
